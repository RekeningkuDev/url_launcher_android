...
final class MethodCallHandlerImpl implements MethodCallHandler {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    switch (call.method) {
      ...
      case "launch":
        ...
        break;
      case "listUrlLaunchingApps":
        listUrlLaunchingApps(result, url);
        break;
      case "closeWebView":
  ...
  private void listUrlLaunchingApps(Result result, String url) {
    result.success(urlLauncher.listUrlLaunchingApps(url));
  }
  ...
  private void onLaunch(MethodCall call, Result result, String url) {
    final String forcePackageName = call.argument("forcePackageName");
    ...
    LaunchStatus launchStatus =
            urlLauncher.launch(url, forcePackageName, headersBundle, useWebView, enableJavaScript, enableDomStorage);
